...
const url = 'https://firebasestorage.googleapis.com/v0/b/firstapp-a8bdd.appspot.com/o/Apis%2FcityContains%2Fbologne.json?alt=media&token=25a2a0e4-815d-491f-bf5c-b507e2ba80cd';
const { width, height } = Dimensions.get('screen');

export const BologneComponent = () => {
        ...
        <>
            {carregando?
                ...
                <View>
                    ...
                    >
                        <Text style={[styles.heading],{fontSize:32,textAlign:'center',color:'#232654'}}>Bologne</Text>
