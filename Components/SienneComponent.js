...
const url = 'https://firebasestorage.googleapis.com/v0/b/firstapp-a8bdd.appspot.com/o/Apis%2FcityContains%2Fsienne.json?alt=media&token=df9e34aa-98c0-4f6a-b225-db38048c718e';
const { width, height } = Dimensions.get('screen');

export const SienneComponent = () => {
        ...
        <>
            {carregando?
                ...
                <View>
                    ...
                    >
                        <Text style={[styles.heading],{fontSize:32,textAlign:'center',color:'#232654'}}>Sienne</Text>
