...
const url = 'https://firebasestorage.googleapis.com/v0/b/firstapp-a8bdd.appspot.com/o/Apis%2FcityContains%2Fparme.json?alt=media&token=9275cdb4-d9b0-49fb-957b-086902541def';
const { width, height } = Dimensions.get('screen');

export const ParmeComponent = () => {
        ...
        <>
            {carregando?
                ...
                <View>
                    ...
                    >
                        <Text style={[styles.heading],{fontSize:32,textAlign:'center',color:'#232654'}}>Parme</Text>
