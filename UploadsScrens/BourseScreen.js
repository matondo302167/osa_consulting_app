    ...
    return(
      <>
       <StatusBar
        ...
        {
          loading?
            <ActivityIndicator size="large" color="back" style={styles.safe_area_view}/>
            :
            <SafeAreaView style={styles.safe_area_view}>
              <Animated.ScrollView>
                <View style={styles.footer}>
                  ...
                  Nous vous conseillons de l'insérer en format pdf.
                  </Text>
